# 1 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\buyingprocess\\\\combined_BuyingProcess.c"
...
# 1 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\buyingprocess\\\\combined_BuyingProcess.c" 2
...
# 2 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\buyingprocess\\\\combined_BuyingProcess.c" 2
...
# 3 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\buyingprocess\\\\combined_BuyingProcess.c" 2
...
# 4 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\buyingprocess\\\\combined_BuyingProcess.c" 2
...

{
	...
	lr_end_transaction("Транзакция 2: Загрузка домашней страницы", 2);
	...
	lr_end_transaction("Транзакция 3: Процесс покупки билета с возвращением на домашнюю страницу", 2);
	
		return 0;
}
# 5 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\buyingprocess\\\\combined_BuyingProcess.c" 2
...
# 6 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\buyingprocess\\\\combined_BuyingProcess.c" 2
