# 1 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\authorizationprocess\\\\combined_AuthorizationProcess.c"
...
# 1 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\authorizationprocess\\\\combined_AuthorizationProcess.c" 2
...
# 2 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\authorizationprocess\\\\combined_AuthorizationProcess.c" 2
...
# 3 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\authorizationprocess\\\\combined_AuthorizationProcess.c" 2
...
# 4 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\authorizationprocess\\\\combined_AuthorizationProcess.c" 2
...
Action()
{
	...
	web_custom_request("mer_login.gif",
		...
		"Snapshot=t8.inf",
		"LAST");
	lr_end_sub_transaction("Сабтранзакция 01: Время прогрузки домашней страницы", 2);
	...
	lr_end_sub_transaction("Сабтранзакция 02: Отправка данных для регистрации", 0);
	...
	lr_end_transaction("Транзакция 1: Время авторизации", 2);
	
	return 0;
}
# 5 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\authorizationprocess\\\\combined_AuthorizationProcess.c" 2
...
# 6 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\authorizationprocess\\\\combined_AuthorizationProcess.c" 2
