# 1 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\signupprocess\\\\combined_SignUpProcess.c"
...
# 1 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\signupprocess\\\\combined_SignUpProcess.c" 2
...
# 2 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\signupprocess\\\\combined_SignUpProcess.c" 2
...
# 3 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\signupprocess\\\\combined_SignUpProcess.c" 2
...
# 4 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\signupprocess\\\\combined_SignUpProcess.c" 2
...
Action()
{
	...
	lr_end_transaction("Транзакция 1: Прогрузка главной страницы", 2);
	...
	lr_end_transaction("Транзакция 2: Прогрузка формы регистрации", 2);
	...
	lr_end_transaction("Транзакция 3: Отправка заполненных данных на бэк",2);
	...
	lr_end_transaction("Транзакция 4: Редирект на главную страницу",2);
	
		return 0;
}
# 5 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\signupprocess\\\\combined_SignUpProcess.c" 2
...
# 6 "c:\\users\\smst-n-72.desktop-c7ijnlv\\documents\\vugen\\scripts\\signupprocess\\\\combined_SignUpProcess.c" 2
